    ...
    <div class="item">
      ...
      <div class="d-f f-w-w">
        <div v-for="(item,index) in more" :key="index">
          ...
          <div class="font t-o-e p-r2 p-l2 t-a-c">{{item.name}}</div>
          <div class="d-f font t-o-e p-r2 p-l2">
            <div class="t-a-c">{{item.adname}}</div>
            <div class="m-l1 t-a-c">{{item.address}}</div>
          </div>
        </div>
      </div>
    </div>
